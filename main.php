...
<body>
  <div class="sidebar">
    ...
    <ul class="nav-list">
      ...
      <li>
       <a href="#" onclick="location.href='itemlist.html'">
        <i><span class="iconify" data-icon="bx:bx-sitemap"></span></i>
        <span class="links_name" onclick="location.href='itemlist.html'">Item List</span>
      </a>
      <span class="tooltip" onclick="location.href='itemlist.html'">Items List</span>
    </li>
